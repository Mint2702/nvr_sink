...
class GCalendar:
    def __init__(self, creds_path: str, token_path: str, scopes: str or list = 'https://www.googleapis.com/auth/calendar'):
        """
        Setting up calendar
        """
        creds = None
    ...
    def create_event_(self, calendar_id: str, summary: str, location: str,
                      description: str, start_time: str,
                      end_time: str or None = None) -> str:
        """
            format: "%Y-%m-%dT%H:%M:%S" 
            ex: 2019-11-12T15:00
        """
    ...
    def get_events(self, calendar_id: str) -> dict:
        ...
        events_result = self.service.events().list(calendarId=calendar_id,
                                                   timeMin=nowISO, timeMax=nowffISO,
                                                   singleEvents=True,
